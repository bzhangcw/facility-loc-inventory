...
# python facility-loc-inventory/ncs_for_template.py --if_del_col 0 &>output/del_cols_log/0.log
# python facility-loc-inventory/ncs_for_template.py --if_del_col 1 --del_col_freq 3 &>output/del_cols_log/131.log
# python facility-loc-inventory/ncs_for_template.py --if_del_col 1 --del_col_freq 2 &>output/del_cols_log/121.log

python facility-loc-inventory/ncs_for_template.py --fpath 'data/us_generate_202403151725/' --if_del_col False &>output/del_cols_log/us_generate_202403151725_0.log
