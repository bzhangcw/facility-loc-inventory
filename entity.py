...
class Edge:
    ...
    def get_edge_sku_list_with_transportation_cost(
        ...
        sku_list_with_fixed_transportation_cost = (
            self.intersect_list(
                sku_list, self.transportation_sku_fixed_cost.index.tolist()
            )
            if self.transportation_sku_fixed_cost is not None
            else list()
        )

        sku_list_with_unit_transportation_cost = (
            self.intersect_list(
                sku_list, self.transportation_sku_unit_cost.index.tolist()
            )
            if self.transportation_sku_unit_cost is not None
            else list()
        )
