...
def init_cols_from_lp_rounding(_cg_instance):
    """
    use LP rounding results to initialize the columns
    ...
    variables = full_model.model.getVars()
    binary_vars_index = []
    for v in variables:
        if v.getType() != COPT.CONTINUOUS:
